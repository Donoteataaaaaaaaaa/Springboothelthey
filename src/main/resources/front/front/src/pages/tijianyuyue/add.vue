    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="套餐价格" prop="taocanjiage">
            <el-input v-model="ruleForm.taocanjiage" 
                placeholder="套餐价格" clearable readonly></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="手机号码" prop="shoujihaoma">
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('tijianyuyue/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
      ...
      onSubmit() {
        ...
        obj.keyuerenshu = obj.keyuerenshu - this.ruleForm.keyuerenshu
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          obj.keyuerenshu = parseFloat(obj.keyuerenshu) - parseFloat(this.ruleForm.keyuerenshu)

                          this.$http.post(table+`/update`,obj).then(res => {});
                          this.$http.post('tijianyuyue/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
