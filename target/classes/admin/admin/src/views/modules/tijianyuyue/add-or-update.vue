<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="体检项目" prop="tijianxiangmu">
					<el-input v-model="ruleForm.tijianxiangmu" placeholder="体检项目" clearable  :readonly="ro.tijianxiangmu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="体检项目" prop="tijianxiangmu">
					<el-input v-model="ruleForm.tijianxiangmu" placeholder="体检项目" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.taocantupian" label="套餐图片" prop="taocantupian">
					<file-upload
						tip="点击上传套餐图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-else-if="ruleForm.taocantupian" label="套餐图片" prop="taocantupian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.taocantupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="体检单位" prop="tijiandanwei">
					<el-input v-model="ruleForm.tijiandanwei" placeholder="体检单位" clearable  :readonly="ro.tijiandanwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="体检单位" prop="tijiandanwei">
					<el-input v-model="ruleForm.tijiandanwei" placeholder="体检单位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="套餐价格" prop="taocanjiage">
					<el-input v-model="ruleForm.taocanjiage" placeholder="套餐价格" clearable  :readonly="ro.taocanjiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="套餐价格" prop="taocanjiage">
					<el-input v-model="ruleForm.taocanjiage" placeholder="套餐价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="可约人数" prop="keyuerenshu">
					<el-input v-model="ruleForm.keyuerenshu" placeholder="可约人数" clearable  :readonly="ro.keyuerenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="可约人数" prop="keyuerenshu">
					<el-input v-model="ruleForm.keyuerenshu" placeholder="可约人数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="体检地点" prop="tijiandidian">
					<el-input v-model="ruleForm.tijiandidian" placeholder="体检地点" clearable  :readonly="ro.tijiandidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="体检地点" prop="tijiandidian">
					<el-input v-model="ruleForm.tijiandidian" placeholder="体检地点" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="date" v-if="type!='info'" label="预约时间" prop="yuyueshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.yuyueshijian" label="预约时间" prop="yuyueshijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="textarea" v-if="type!='info'" label="体检内容" prop="tijianneirong">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else-if="ruleForm.tijianneirong" label="体检内容" prop="tijianneirong">
...
export default {
	...
	computed: {
		...
		zongjine:{
			get: function () {
				return 1*this.ruleForm.taocanjiage*this.ruleForm.keyuerenshu
			}
		},
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.keyuerenshu = 0
				this.ro.keyuerenshu = false;
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.keyuerenshu = objcross.keyuerenshu - this.ruleForm.keyuerenshu
	      if(objcross.keyuerenshu<0){
		this.$message.error("可约人数不足");
		return
	      }
                }
